import { n as about_default } from "./router-Ctb7_hdP.js";
...
import { ArrowUpRight, BadgeDollarSign, Briefcase, Calculator, ExternalLink, GraduationCap, LayoutDashboard, Linkedin, Mail, MapPin, Menu, MonitorSmartphone, Package, ReceiptText, ShieldCheck, ShoppingCart, UserCog, Users, X } from "lucide-react";
...
//#endregion
//#region src/components/site/ui.jsx
...
function CursorGlow() {
	...
	return /* @__PURE__ */ jsx(motion.div, {
		...
		children: /* @__PURE__ */ jsx("div", { className: "h-full w-full rounded-full bg-[radial-gradient(circle,var(--violet-200),transparent_65%)]" })
	});
}
...
function Background() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: "islamic-pattern absolute inset-0" }),
...
function Particles() {
	...
	return /* @__PURE__ */ jsx(Fragment, { children: dots.map((d) => /* @__PURE__ */ jsx(motion.span, {
...
function Eyebrow({ children }) {
	return /* @__PURE__ */ jsxs("span", {
		...
		children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-violet-500" }), children]
	});
}
...
//#endregion
//#region src/assets/laptop-hero.png
var laptop_hero_default = "/assets/laptop-hero-5Rs7Jo2-.png";
//#endregion
//#region src/components/site/HeroLaptop.jsx
var orbiters = [
	{
		label: "React",
		cls: "left-[-4%] top-[16%]",
...
function HeroLaptop() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute left-1/2 top-1/2 h-[55%] w-[80%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-violet-300/45 blur-[70px]" }),
			/* @__PURE__ */ jsx(motion.div, {
				style: {
					rotateY: rotY,
					rotateX: rotX,
			...
			orbiters.map((o, i) => /* @__PURE__ */ jsx(motion.div, {
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("span", { className: `h-1.5 w-1.5 rounded-full sm:h-2 sm:w-2 ${o.dot}` }), o.label]
				})
			}, o.label))
		]
	});
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs(motion.nav, {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: NAV.map((n) => /* @__PURE__ */ jsxs("a", {
							...
							children: [active === n.id && /* @__PURE__ */ jsx(motion.span, {
								layoutId: "nav-pill",
								transition: {
									type: "spring",
									stiffness: 300,
					...
					/* @__PURE__ */ jsxs("a", {
						...
						children: ["Let's Talk", /* @__PURE__ */ jsx("span", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: ["Let's Talk ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
				})]
			}) })]
		})
	});
...
function GroceryPosDetailsModal() {
	...
	return /* @__PURE__ */ jsxs(DialogPrimitive.Root, {
		...
		children: [/* @__PURE__ */ jsx(DialogPrimitive.Trigger, {
			asChild: true,
			children: /* @__PURE__ */ jsxs(motion.button, {
				...
				children: ["Project Details ", /* @__PURE__ */ jsx(LayoutDashboard, { className: "h-4 w-4" })]
			})
		}), /* @__PURE__ */ jsxs(DialogPrimitive.Portal, { children: [/* @__PURE__ */ jsx(DialogPrimitive.Overlay, { className: "fixed inset-0 z-[70] bg-ink/40 backdrop-blur-md duration-300 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0" }), /* @__PURE__ */ jsxs(DialogPrimitive.Content, {
					...
					children: [
							...
							children: [
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsxs("span", {
										...
										children: [/* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-violet-500" }), "02 — POINT OF SALE SYSTEM"]
									}), /* @__PURE__ */ jsx("span", {
						...
						/* @__PURE__ */ jsxs("section", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: GROCERY_FEATURES.map(({ title, Icon, text }, index) => /* @__PURE__ */ jsxs(motion.article, {
									initial: shouldReduceMotion ? false : {
										opacity: 0,
										y: 10
									},
						...
						/* @__PURE__ */ jsxs("section", {
							...
							children: [/* @__PURE__ */ jsx("h3", {
								...
								children: GROCERY_TECH_STACK.map((stackGroup) => /* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										children: stackGroup.items.map((item) => /* @__PURE__ */ jsx("span", {
...
function ProjectCard({ p, i }) {
	...
	return /* @__PURE__ */ jsx(Reveal, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "absolute inset-0 rounded-[32px] bg-[linear-gradient(120deg,#845ec2,#be93fd,#faccff,#845ec2)] bg-[length:200%_100%] opacity-40 transition-opacity duration-500 group-hover:opacity-100 group-hover:animate-shimmer" }), /* @__PURE__ */ jsx(GlassCard, {
				tilt: true,
				...
				children: /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: /* @__PURE__ */ jsxs("picture", { children: [p.imageMobile && /* @__PURE__ */ jsx("source", {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								/* @__PURE__ */ jsx("span", { children: p.n }),
								/* @__PURE__ */ jsx("span", { className: "h-px w-8 bg-violet-300" }),
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [p.details === "grocery-pos" ? /* @__PURE__ */ jsx(GroceryPosDetailsModal, {}) : /* @__PURE__ */ jsxs(MagneticButton, {
								href: p.url,
								target: "_blank",
								rel: "noreferrer",
								...
								children: ["Live preview ", /* @__PURE__ */ jsx(ExternalLink, { className: "h-4 w-4" })]
								...
								children: ["Discuss project ", /* @__PURE__ */ jsx(Mail, { className: "h-4 w-4" })]
							})]
						})
					] })]
				})
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs(Section, {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [
						/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "Hania Mansoor — Pakistan" }) }),
						/* @__PURE__ */ jsx(Reveal, {
							delay: .1,
						...
						/* @__PURE__ */ jsx(Reveal, {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs(MagneticButton, {
									...
									children: ["View my work ", /* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4" })]
								}), /* @__PURE__ */ jsxs(MagneticButton, {
									href: "#contact",
									...
									children: ["Get in touch ", /* @__PURE__ */ jsx(Mail, { className: "h-4 w-4" })]
								})]
							})
						}),
						/* @__PURE__ */ jsx(Reveal, {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx(MapPin, { className: "h-3.5 w-3.5 text-violet-500" }), " Available for freelance"]
							})
						})
					] }), /* @__PURE__ */ jsx(Reveal, {
						delay: .15,
						...
						children: /* @__PURE__ */ jsx(HeroLaptop, {})
					})]
				})]
			}),
			/* @__PURE__ */ jsxs(Section, {
				id: "about",
				children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "About" }) }), /* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(Reveal, {
						...
						children: /* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(motion.div, {
								...
								}), /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute inset-0 bg-gradient-to-t from-violet-700/25 via-transparent to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" })]
							})]
						})
					}), /* @__PURE__ */ jsxs("div", {
						className: "min-w-0",
						children: [
							/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Heading, { children: "Designing calm, building precise." }) }),
							/* @__PURE__ */ jsx(Reveal, {
								delay: .1,
								children: /* @__PURE__ */ jsx("p", {
			...
			/* @__PURE__ */ jsxs(Section, {
				id: "stack",
				children: [
					/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "Stack" }) }),
					/* @__PURE__ */ jsx(Reveal, {
						delay: .05,
					...
					/* @__PURE__ */ jsx(Reveal, {
						delay: .1,
						children: /* @__PURE__ */ jsx("div", { className: "mt-10 h-px w-full bg-gradient-to-r from-violet-400/60 to-transparent" })
					}),
					/* @__PURE__ */ jsx("div", {
						className: "mt-10 grid grid-cols-2 gap-8 sm:gap-10 lg:grid-cols-4",
						children: STACK.map((s, i) => /* @__PURE__ */ jsx(Reveal, {
							delay: .06 * i,
							children: /* @__PURE__ */ jsxs("div", {
								className: "min-w-0",
								children: [/* @__PURE__ */ jsx("div", {
									...
									children: s.items.map((t) => /* @__PURE__ */ jsx("li", {
			...
			/* @__PURE__ */ jsxs(Section, {
				id: "projects",
				className: "gap-12",
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "Selected work" }) }), /* @__PURE__ */ jsx(Reveal, {
					delay: .05,
					children: /* @__PURE__ */ jsx(Heading, {
			...
			/* @__PURE__ */ jsxs(Section, {
				id: "experience",
				children: [
					/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "Experience" }) }),
					/* @__PURE__ */ jsx(Reveal, {
						delay: .05,
						children: /* @__PURE__ */ jsx(Heading, {
							className: "mt-6 max-w-2xl",
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										...
										children: [/* @__PURE__ */ jsx(Briefcase, { className: "h-3.5 w-3.5 shrink-0 text-violet-500 sm:hidden" }), e.period]
									}),
									/* @__PURE__ */ jsx("h3", {
			...
			/* @__PURE__ */ jsxs(Section, {
				id: "education",
				children: [
					/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "Education" }) }),
					/* @__PURE__ */ jsx(Reveal, {
						delay: .05,
						children: /* @__PURE__ */ jsx(Heading, {
							className: "mt-6 max-w-2xl",
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: EDUCATION.map((e, i) => /* @__PURE__ */ jsx(Reveal, {
							...
							children: /* @__PURE__ */ jsxs(GlassCard, {
								...
								children: [
									/* @__PURE__ */ jsx(GraduationCap, { className: "h-6 w-6 text-violet-700" }),
									/* @__PURE__ */ jsx("h3", {
			...
			/* @__PURE__ */ jsx(Section, {
				...
				children: /* @__PURE__ */ jsxs(GlassCard, {
					...
					children: [
						/* @__PURE__ */ jsx(Reveal, { children: /* @__PURE__ */ jsx(Eyebrow, { children: "Contact" }) }),
						/* @__PURE__ */ jsx(Reveal, {
							delay: .05,
						...
						/* @__PURE__ */ jsx(Reveal, {
							...
							children: /* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs(MagneticButton, {
									...
									children: ["LinkedIn ", /* @__PURE__ */ jsx(Linkedin, { className: "h-4 w-4" })]
								})]
							})
						})
					]
					...
					children: [/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("nav", {
								...
								children: NAV.slice(1, 5).map((n) => /* @__PURE__ */ jsx("a", {
									href: `#${n.id}`,
